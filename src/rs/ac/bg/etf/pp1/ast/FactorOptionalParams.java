...
public class FactorOptionalParams extends Factor {

    private Designator Designator;
    private ActualPars ActualPars;

    public FactorOptionalParams (Designator Designator, ActualPars ActualPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorOptionalParams(\n");
