...
public class ExprSecondOptionClassNoMinus extends Expr {

    private Term Term;
    private ExprOptionalList ExprOptionalList;

    public ExprSecondOptionClassNoMinus (Term Term, ExprOptionalList ExprOptionalList) {
        this.Term=Term;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ExprSecondOptionClassNoMinus(\n");
